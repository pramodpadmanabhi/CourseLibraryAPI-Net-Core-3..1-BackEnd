...
namespace CourseLibraryAPI.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public ActionResult<CourseDto> CreateCourseForAuthor(Guid authorId, CourseForCreationDto course)
        {
            ...
            return CreatedAtAction("GetCourseForAuthor", new { authorId = courseToReturn.Id }, courseToReturn);
        ...
        public IActionResult UpdateCourseForAuthor(Guid authorId,Guid courseId,CourseForUpdateDto course)
        {
            ...
            var courseAuthorFromRepo = _courseLibraryRepository.GetCourse(authorId, courseId);
            ...
            _mapper.Map(course, courseAuthorFromRepo);
            _courseLibraryRepository.UpdateCourse(courseAuthorFromRepo);
            _courseLibraryRepository.Save();
            return NoContent();
        }
        [HttpPatch("{courseId}")]
        ...
        public ActionResult DeleteCourseForAuthor(Guid authorId,Guid courseId)
        {
            ...
            _courseLibraryRepository.DeleteCourse(courseAuthorFromRepo);
            _courseLibraryRepository.Save();
